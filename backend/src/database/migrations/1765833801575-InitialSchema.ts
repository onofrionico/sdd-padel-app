...
export class InitialSchema1765833801575 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
          `CREATE TYPE "public"."association_memberships_role_enum" AS ENUM ('admin','organizer','member')`,
        );
        ...
        await queryRunner.query(
          `CREATE TYPE "public"."categories_level_enum" AS ENUM ('beginner','intermediate','advanced','professional')`,
        );
